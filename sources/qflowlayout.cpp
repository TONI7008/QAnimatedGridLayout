...
QFlowLayout::QFlowLayout(QWidget *parent) :
    QGridLayout(parent),
...
void QFlowLayout::addWidget(QWidget *widget, short _row, short _column, short _rowSpan, short columnSpan, Qt::Alignment align)
{
    if (!widget) return;
...
bool QFlowLayout::contains(QWidget *widget) const
{
    ...
    return std::any_of(widgetList.cbegin(), widgetList.cend(),
                       [widget](const WidgetWrapper &w) { return w.widget == widget; });
}


bool QFlowLayout::isZoomed() const
{
    return zoomedWidgetPtr!=nullptr;
}

void QFlowLayout::removeWidget(QWidget *widget)
{
    if(!widget) return;
...
void QFlowLayout::zoomTo(QWidget *widget) {
...
QWidget *QFlowLayout::zoomedWidget()
{
    return zoomedWidgetPtr;
}


bool QFlowLayout::isAnimating() const
{
    return m_isAnimating;
}

QFlowLayout::cellWrapper QFlowLayout::getWidgetPosition(QWidget *widget) const
{
...
void QFlowLayout::setAnimationDuration(int duration) {
    m_duration = duration;
}

int QFlowLayout::animationDuration() const {
    return m_duration;
}

void QFlowLayout::setEasingCurve(const QEasingCurve &easingCurve) {
    m_easing = easingCurve;
}

QEasingCurve QFlowLayout::easingCurve() const {
    return m_easing;
}

void QFlowLayout::repopulate()
{
...
void QFlowLayout::updateOriginalGeometriesForResize()
{
